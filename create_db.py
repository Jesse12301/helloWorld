...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'jleibovi', 'email': 'jleibovi@umd.edu', 'first_name': 'Jesse', 'last_name': 'Leibovitch',
         'password': generate_password_hash('jleibovi', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
